    ...
    >
      ...
      <div className={boxClass}>
        <textarea
          ...
          className="min-h-[60px] w-full flex-1 resize-none bg-transparent px-x1 text-body-1-normal-regular text-text-primary outline-none placeholder:text-text-placeholder disabled:cursor-not-allowed disabled:text-text-disabled-secondary disabled:placeholder:text-text-disabled-secondary"
          {...textareaProps}
        />
        {maxLength !== undefined && (
